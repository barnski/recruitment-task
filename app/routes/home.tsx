...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "Shared Tab" },
    { name: "description", content: "Split bills with your group" },
  ]
}
...
export async function action({ request }: Route.ActionArgs) {
  ...
  return { ok: true } // truthy result lets the form know the submit finished
}
...
export default function Home({ loaderData }: Route.ComponentProps) {
  ...
  // Clear the form once a submit completes (fetcher goes idle with data returned).
  useEffect(() => {
